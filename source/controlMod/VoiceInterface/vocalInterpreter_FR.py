"""
@file speech_fr.py
@brief Script pour récupérer une commande vocale en français via le micro.
@author Victor CHALUMEAUX
"""

import speech_recognition as sr

def get_speech_fr() -> str:
    """
    @brief Récupère la commande vocale en français via le micro.
